...
Automatisation des simulations régionales AquaCrop
...
les dates de début et fin de simulation,
les paramètres liés à l’année et aux cycles culturels.
Une fois le projet PRM créé, le script exécute AquaCrop via subprocess, puis réorganise les fichiers de sortie pour simplifier leur exploitation, en supprimant les fichiers système inutiles et en plaçant le PRM et les résultats dans le dossier du cluster.
Cette automatisation permet de simuler rapidement plusieurs années et clusters, en assurant une correspondance exacte entre les données climatiques, les fichiers sol et le fichier de culture.
